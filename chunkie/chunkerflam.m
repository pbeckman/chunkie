...
if strcmpi(flamtype,'rskelf')
    ...
    pxyfun = @(lvl) proxyfunbylevel(width,lvl,optsnpxy, ...
        chnkrs,wts,kern,opdims_mat,ifaddtrans,l2scale,verb && proxybylevel);
    if ~proxybylevel
...
if strcmpi(flamtype,'rskel') 
    ...
    pxyfunr = @(lvl) proxyfunrbylevel(width,lvl,optsnpxy, ...
        chnkr,wts,kern,opdims,verb && proxybylevel);
    if ~proxybylevel
...
function pxyfunlvl = proxyfunbylevel(width,lvl,optsnpxy, ...
    chnkrs,wts,kern,opdims_mat,ifaddtrans,l2scale,verb ...
    )
    ...
    pxyfunlvl = @(x,slf,nbr,l,ctr) chnk.flam.proxyfun(slf,nbr,l,ctr,chnkrs,wts, ...
